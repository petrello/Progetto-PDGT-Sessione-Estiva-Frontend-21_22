...
ExchangeDTO _$ExchangeDTOFromJson(Map<String, dynamic> json) {
  return _ExchangeDTO.fromJson(json);
}
...
mixin _$ExchangeDTO {
  ...
  @JsonKey(ignore: true)
  $ExchangeDTOCopyWith<ExchangeDTO> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ExchangeDTOCopyWith<$Res> {
  factory $ExchangeDTOCopyWith(
          ExchangeDTO value, $Res Function(ExchangeDTO) then) =
      _$ExchangeDTOCopyWithImpl<$Res>;
  $Res call(
      {String exchangeId,
      String website,
      String name,
...
/// @nodoc
class _$ExchangeDTOCopyWithImpl<$Res> implements $ExchangeDTOCopyWith<$Res> {
  _$ExchangeDTOCopyWithImpl(this._value, this._then);

  final ExchangeDTO _value;
  // ignore: unused_field
  final $Res Function(ExchangeDTO) _then;
...
/// @nodoc
abstract class _$$_ExchangeDTOCopyWith<$Res>
    implements $ExchangeDTOCopyWith<$Res> {
  factory _$$_ExchangeDTOCopyWith(
          _$_ExchangeDTO value, $Res Function(_$_ExchangeDTO) then) =
      __$$_ExchangeDTOCopyWithImpl<$Res>;
  @override
  $Res call(
      {String exchangeId,
      String website,
...
/// @nodoc
class __$$_ExchangeDTOCopyWithImpl<$Res> extends _$ExchangeDTOCopyWithImpl<$Res>
    implements _$$_ExchangeDTOCopyWith<$Res> {
  __$$_ExchangeDTOCopyWithImpl(
      _$_ExchangeDTO _value, $Res Function(_$_ExchangeDTO) _then)
      : super(_value, (v) => _then(v as _$_ExchangeDTO));

  @override
  _$_ExchangeDTO get _value => super._value as _$_ExchangeDTO;
...
/// @nodoc
@JsonSerializable()
class _$_ExchangeDTO implements _ExchangeDTO {
  const _$_ExchangeDTO(
  ...
  factory _$_ExchangeDTO.fromJson(Map<String, dynamic> json) =>
      _$$_ExchangeDTOFromJson(json);
  ...
  @override
  String toString() {
    return 'ExchangeDTO(exchangeId: $exchangeId, website: $website, name: $name, dataStart: $dataStart, dataEnd: $dataEnd, dataQuoteStart: $dataQuoteStart, dataQuoteEnd: $dataQuoteEnd, dataOrderbookStart: $dataOrderbookStart, dataOrderbookEnd: $dataOrderbookEnd, dataTradeStart: $dataTradeStart, dataTradeEnd: $dataTradeEnd, dataSymbolsCount: $dataSymbolsCount, volume1hrsUsd: $volume1hrsUsd, volume1dayUsd: $volume1dayUsd, volume1mthUsd: $volume1mthUsd)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$$_ExchangeDTOCopyWith<_$_ExchangeDTO> get copyWith =>
      __$$_ExchangeDTOCopyWithImpl<_$_ExchangeDTO>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ExchangeDTOToJson(this);
  }
}

abstract class _ExchangeDTO implements ExchangeDTO {
  const factory _ExchangeDTO(
      ...
      required final int volume1mthUsd}) = _$_ExchangeDTO;

  factory _ExchangeDTO.fromJson(Map<String, dynamic> json) =
      _$_ExchangeDTO.fromJson;
