...
ExIconDTO _$ExIconDTOFromJson(Map<String, dynamic> json) {
  return _ExIconDTO.fromJson(json);
}
...
mixin _$ExIconDTO {
  ...
  @JsonKey(ignore: true)
  $ExIconDTOCopyWith<ExIconDTO> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ExIconDTOCopyWith<$Res> {
  factory $ExIconDTOCopyWith(ExIconDTO value, $Res Function(ExIconDTO) then) =
      _$ExIconDTOCopyWithImpl<$Res>;
  $Res call(
      {String exchangeId,
      String website,
      String name,
...
/// @nodoc
class _$ExIconDTOCopyWithImpl<$Res> implements $ExIconDTOCopyWith<$Res> {
  _$ExIconDTOCopyWithImpl(this._value, this._then);

  final ExIconDTO _value;
  // ignore: unused_field
  final $Res Function(ExIconDTO) _then;
...
/// @nodoc
abstract class _$$_ExIconDTOCopyWith<$Res> implements $ExIconDTOCopyWith<$Res> {
  factory _$$_ExIconDTOCopyWith(
          _$_ExIconDTO value, $Res Function(_$_ExIconDTO) then) =
      __$$_ExIconDTOCopyWithImpl<$Res>;
  @override
  $Res call(
      {String exchangeId,
      String website,
...
/// @nodoc
class __$$_ExIconDTOCopyWithImpl<$Res> extends _$ExIconDTOCopyWithImpl<$Res>
    implements _$$_ExIconDTOCopyWith<$Res> {
  __$$_ExIconDTOCopyWithImpl(
      _$_ExIconDTO _value, $Res Function(_$_ExIconDTO) _then)
      : super(_value, (v) => _then(v as _$_ExIconDTO));

  @override
  _$_ExIconDTO get _value => super._value as _$_ExIconDTO;
...
/// @nodoc
@JsonSerializable()
class _$_ExIconDTO implements _ExIconDTO {
  const _$_ExIconDTO(
  ...
  factory _$_ExIconDTO.fromJson(Map<String, dynamic> json) =>
      _$$_ExIconDTOFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$$_ExIconDTOCopyWith<_$_ExIconDTO> get copyWith =>
      __$$_ExIconDTOCopyWithImpl<_$_ExIconDTO>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ExIconDTOToJson(this);
  }
}

abstract class _ExIconDTO implements ExIconDTO {
  const factory _ExIconDTO(
      ...
      required final int volume1mthUsd}) = _$_ExIconDTO;

  factory _ExIconDTO.fromJson(Map<String, dynamic> json) =
      _$_ExIconDTO.fromJson;
